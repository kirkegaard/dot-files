...
sudo scutil --set ComputerName "fugl"
sudo scutil --set HostName "fugl"
sudo scutil --set LocalHostName "fugl"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "fugl"
...
systemsetup -settimezone "Europe/Copenhagen" > /dev/null
...
open "$HOME/.dotfiles/Christian.terminal"
sleep 1 # Wait a bit to make sure the theme is loaded
defaults write com.apple.terminal "Default Window Settings" -string "Christian"
defaults write com.apple.terminal "Startup Window Settings" -string "Christian"
